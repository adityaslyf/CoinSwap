...
const SwapForm: React.FC = () => {
  ...
  const renderInterface = () => {
    if (currentTrade.from) {
      (document.getElementById("from_token_img") as HTMLImageElement).src =
        currentTrade.from.logoURI;
      (document.getElementById("from_token_text") as HTMLElement).innerText =
        currentTrade.from.symbol;
    }
    if (currentTrade.to) {
      (document.getElementById("to_token_img") as HTMLImageElement).src =
        currentTrade.to.logoURI;
      (document.getElementById("to_token_text") as HTMLElement).innerText =
  ...
  const connectWallet = async () => {
    if (typeof window.ethereum !== "undefined") {
      ...
      document.getElementById("login_button")!.innerText =
  ...
  const getPrice = async () => {
    if (
      !currentTrade.from ||
      !currentTrade.to ||
      !(document.getElementById("from_amount")! as HTMLInputElement).value
    )
      return;
    ...
    (document.getElementById("to_amount")! as HTMLInputElement).value = String(
      swapQuoteJSON.buyAmount / 10 ** currentTrade.to.decimals
    );
    (document.getElementById("gas_estimate") as HTMLElement).innerText =
  ...
  const trySwap = async () => {
    ...
    const txParams = {
      ...swapQuoteJSON,
      from: account,
      gas: swapQuoteJSON.estimatedGas / 10000,
    };
          ...
          <div id="form">
            <div className="swapbox">
              ...
              >
                ...
                <span id="from_token_text">Select a Token</span>
              </div>
            ...
            <div className="swapbox">
              ...
              >
                ...
                <span id="to_token_text">Select a Token</span>
              </div>
              <div className="swapbox_select ">
                <input
                  className="number form-control"
